...
def ask_positive_question(statement):
    '''Present a statement and ask if the individual Strongly Disagrees, Disagrees
        Agrees, or Strongly agrees. Return a score that will be calculated as a total.
            Parameter: Statement
            return: score from the response'''
    print(statement)
